...
} from "@/shared/lib/utils/char-utils";
import { useOnWindowResize } from "@/shared/hooks/use-on-window-resize";
...
const AreaChart = React.forwardRef<HTMLDivElement, AreaChartProps>(
  (props, ref) => {
    ...
    const isManyPoints = data.length > 10;

    const showAllTicks = isLargeScreen && !isManyPoints;
        ...
        <ResponsiveContainer>
          ...
          >
            ...
            <YAxis
              ...
              tick={{
                transform: isRtl ? "translate(30, -3)" : "translate(0, -3)",
              }}
              fill=""
              stroke=""
